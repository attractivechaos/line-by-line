...
// the following class is copied from https://github.com/nacholibre/node-readlines (the n-readlines package)
...
function main(args) {
	if (args.length < 2) {
		console.log("Usage: node paste-nr2.js <in1.txt> <in2.txt>");
		return;
	}
